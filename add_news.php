...
function store_news($news_title, $news_content, $news_author){
	//echo $news_title .$news_content .$news_author; //saame näidata mis info me kõik kokku kraabime formidest
...
Uudiste lisamine
	...
	<p>See leht on valminud teise Zoomiloengu ajal.</p>
	<hr>
	<form method="POST">
